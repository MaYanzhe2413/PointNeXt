...
def pointnetpp_from_cfg(batch_size=1):
    points = [1024, 512, 128, 1]
    grouped_points_default = 32
    th = 64
    cfg = OrderedDict([
        ('grouper1', [points[0], points[1], batch_size, 32, 0.2, False, th]),
        ...
        ('grouper2', [points[1], points[2], batch_size, 64, 0.4, False, th]),
        ...
        ('grouper3', [points[2], points[3], batch_size, points[2], None, False, th]),  # GroupAll
