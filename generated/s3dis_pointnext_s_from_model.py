...
def point_config_from_model(batch_size=1):
    points = [1024, 256, 64, 16, 4]
    grouped_points_default = 32
    th = 64
    cfg = OrderedDict([
        ('grouper1', [points[0], points[1], batch_size, 32, 0.1, False, th]),
        ...
        ('grouper2', [points[1], points[2], batch_size, 32, 0.2, False, th]),
        ...
        ('grouper3', [points[2], points[3], batch_size, 32, 0.4, False, th]),
        ...
        ('grouper4', [points[3], points[4], batch_size, 32, 0.8, False, th]),
